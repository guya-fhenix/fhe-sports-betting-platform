...
task('get-tournament-info', 'Get information about a tournament')
  ...
  .setAction(async (taskArgs, hre: HardhatRuntimeEnvironment) => {
    ...
    console.log(`Registration ends: ${new Date(Number(params.registrationEndTime) * 1000).toLocaleString()}`)
    ...
    console.log(`General Closing Window: ${params.generalClosingWindow} seconds`)
